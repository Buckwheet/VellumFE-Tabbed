...
impl super::TuiFrontend {
    ...
    pub(super) fn handle_normal_mode_keys(
        ...
        if modifiers == crate::frontend::KeyModifiers::CTRL {
            match code {
        ...
        if modifiers == crate::frontend::KeyModifiers::SHIFT {
            match code {
    ...
    pub(super) fn handle_picker_keys(
        ...
        let picker = match &mut self.session_picker {
            Some(p) => p,
            None => return Ok(None),
        };
        ...
        match code {
            ...
            KeyCode::Esc => picker.cancel_form(),
