...
pub struct Session {
    ...
    /// Channel to receive server messages (owned by this session)
    pub server_tx: Option<mpsc::UnboundedSender<ServerMessage>>,
    /// Receiver end — polled by the main loop when this session is active
    pub server_rx: Option<mpsc::UnboundedReceiver<ServerMessage>>,
